...
if(isset($_POST["id"])&& !empty($_POST["id"]))
{
    ...
    //Check input errors beforce inserting in database
    if(empty($name_err) && empty($address_err) && empty($salary_err))
    {
        ...
        if($stmt=mysqli_prepare($link, $sql))
        {
            ...
            //Attemp to executed to prepared statement
            if(mysqli_stmt_execute($stmt))
            {
                //record successfully. redirect to landing page
...
{
    //Check exitstence of id parameter before proccessing further
